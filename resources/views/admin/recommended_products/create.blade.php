...
@section('title', 'Create Recommended Product')
...
<div class="wrapper wrapper-content animated fadeInRight">
    <form action="{{ route('admin.settings.recommended-products.store') }}" method="POST">
        @csrf
        {{-- Alert Error --}}
        @if ($errors->any())
                ...
                <div class="card mt-4">
                    <div class="card-body">
                        <button type="submit" class="btn btn-primary">
                            <i class="fa fa-save"></i> Create Recommended Product
                        </button>
                        <a href="{{ route('admin.settings.recommended-products.index') }}" class="btn btn-secondary">
